...
// Логика взаимодействия для MainWindow.xaml
    ...
    // Конец параметров скрытия Альттаба
    ...
    // Конец описания плагинов
        ...
        void tray_MouseClick(object sender, System.Windows.Forms.MouseEventArgs e)
        {
            if (e.Button == System.Windows.Forms.MouseButtons.Left)
            {
                ...
                mascote.thread_Mascot.Suspend();
                mascote.NumAction = 2;
                lab.Text = plg.list_plugMsg[0];
            }
        }
        ...
        {
            if (mascote.thread_Mascot.ThreadState == System.Threading.ThreadState.Suspended)
            {
                mascote.thread_Mascot.Resume();
            }
            if (MenuIsShow == true)
            {
                MenuClose();
